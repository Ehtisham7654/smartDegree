<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="G1Q4L6.aspx.cs" Inherits="SmartDegreeChoice.G1Q4L6" %>
    ...
    <div class="card">
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-md-3"></div>
                <div class="col-md-6">
                    <asp:Label id="lblQ1CS1" runat="server"> <h4>Are you interested in Problem Solving and Logical Thinking?</h4></asp:Label>
                </div>
                <div class="col-md-3"></div>
            </div>
            <div class="row">
