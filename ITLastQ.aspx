<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ITLastQ.aspx.cs" Inherits="SmartDegreeChoice.ITLastQ" %>
    ...
    <div class="card">
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-md-3"></div>
                <div class="col-md-6">
                    <asp:Label id="lblQ1CS1" runat="server"> <h4>Do you enjoy analyzing information that you've read?</h4></asp:Label>
                </div>
                <div class="col-md-3"></div>
            </div>
            <div class="row">
