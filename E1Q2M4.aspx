<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="E1Q2M4.aspx.cs" Inherits="SmartDegreeChoice.E1Q2M4" %>
    ...
    <div class="card">
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-md-3"></div>
                <div class="col-md-6">
                    <asp:Label id="lblQ1CS1" runat="server"> <h4>Do you think you have the ability to think independently?</h4></asp:Label>
                </div>
                <div class="col-md-3"></div>
            </div>
            <div class="row">
