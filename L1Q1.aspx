<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="L1Q1.aspx.cs" Inherits="SmartDegreeChoice.L1Q1" %>
    ...
    <div class="card">
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-md-3"></div>
                <div class="col-md-6">
                    <asp:Label id="lblQ1CS1" runat="server"> <h4>Do you know about ML and have interest in understanding the Machine learning? </h4></asp:Label>
                </div>
                <div class="col-md-3"></div>
            </div>
            <div class="row">
