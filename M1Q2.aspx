<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="M1Q2.aspx.cs" Inherits="SmartDegreeChoice.M1Q2" %>
    ...
    <div class="card">
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-md-3"></div>
                <div class="col-md-6">
                    <asp:Label id="lblQ1CS1" runat="server"> <h4>Are you interested in Learning Low Level Languages like COBOL, Assembly and Machine Language etc?</h4></asp:Label>
                </div>
                <div class="col-md-3"></div>
            </div>
            <div class="row">
